package com.thesis.recipease.model.web.profile;
...
public class WebProfile {
    ...
    public WebProfile(){}
    public WebProfile(int id, String firstName, String lastName, String cookingLevel, String favoriteDish, String favoriteCuisine) {
        this.id = id;
